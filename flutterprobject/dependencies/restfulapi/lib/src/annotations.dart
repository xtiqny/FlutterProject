...
class Get extends Method {
  const Get({String path: "", Map<String, String> headers: const {}})
      : super("GET", path: path, headers: headers);
}
...
class Post extends Method {
  const Post({String path: "", Map<String, String> headers: const {}})
      : super("POST", path: path, headers: headers);
}
...
class Delete extends Method {
  const Delete({String path: "", Map<String, String> headers: const {}})
      : super("DELETE", path: path, headers: headers);
}
...
class Put extends Method {
  const Put({String path: "", Map<String, String> headers: const {}})
      : super("PUT", path: path, headers: headers);
}
...
class Patch extends Method {
  const Patch({String path: "", Map<String, String> headers: const {}})
      : super("PATCH", path: path, headers: headers);
}
...
/// Use to define a cancel callback for the request
///     @Get(path: '/something')
///     CancelableOperation<void> doSomething(@OnCancel() Future<dynamic> doCancel(Request request))
@immutable
class OnCancel {
  const OnCancel();
}
